...
@Config
@Autonomous(name = "red close cycle")
public class RedCloseCycle extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Constants.MAX_LINEAR_SPEED = 0.9;
        Constants.MAX_ROTATIONAL_SPEED = 0.6;
        ...
        CommandScheduler.getInstance().schedule(
                new SequentialCommandGroup(
                        ...
                        new PositionCommand(new Pose(-60, 52, Math.toRadians(-90)))
                                .alongWith(new ArmCommand(1370))
