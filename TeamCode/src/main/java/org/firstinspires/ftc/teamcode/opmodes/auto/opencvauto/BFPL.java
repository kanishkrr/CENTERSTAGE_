            ...
            case LEFT:
                traj = drive.trajectorySequenceBuilder(start)
                        ...
                        .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                            ...
                            intake.angleServoUp();
                        }).strafeLeft(18).turn(Math.toRadians(180))
                        .strafeTo(parkLeft).build();
                break;
            case MIDDLE:
                traj = drive.trajectorySequenceBuilder(start)
                        .UNSTABLE_addTemporalMarkerOffset(0, ()-> {
                        ...
                        .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                            ...
                            intake.angleServoUp();
                        }).strafeLeft(26).turn(Math.toRadians(180))
                        .strafeTo(parkLeft).build();
                break;
            case RIGHT:
                traj = drive.trajectorySequenceBuilder(start)
                        ...
                        .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                            ...
                            intake.angleServoUp();
                        }).strafeLeft(26).turn(Math.toRadians(180)).strafeTo(parkLeft).build();
                break;
        }
