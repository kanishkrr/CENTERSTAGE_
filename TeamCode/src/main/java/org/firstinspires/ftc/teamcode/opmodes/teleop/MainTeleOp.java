...
public class MainTeleOp extends CommandOpMode {
    ...
    public void run() {
        ...
        robot.drivetrain.set(new Pose(gamepad1.left_stick_x*(gamepad1.right_trigger*0.75 + 0.25), -gamepad1.left_stick_y*(gamepad1.right_trigger*0.75 + 0.25), gamepad1.right_stick_x*0.4), 0);

        robot.hang.setPower(0);
        if (gamepad1.left_bumper) robot.hang.setPower(-0.8);
        else if (gamepad1.right_bumper) robot.hang.setPower(0.8);
