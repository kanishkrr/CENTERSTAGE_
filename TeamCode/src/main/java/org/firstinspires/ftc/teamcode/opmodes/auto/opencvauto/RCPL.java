...
@Autonomous
public class RCPL extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        intake.initServos();
        parkLeft = new Vector2d(55, -9);
        leftAlign = new Vector2d(42, -9);
                ...
                traj = drive.trajectorySequenceBuilder(start)
                        .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                         ...
                         .UNSTABLE_addDisplacementMarkerOffset(0, () -> {
                             ...
                             intake.angleServoUp();
                         }).strafeTo(leftAlign).lineToLinearHeading(new Pose2d(parkLeft, Math.toRadians(180)))
                         .build();
            ...
            case MIDDLE:
                traj = drive.trajectorySequenceBuilder(start)
                        ...
                        .UNSTABLE_addDisplacementMarkerOffset(0, () -> {
                            ...
                            intake.angleServoUp();
                        }).strafeTo(leftAlign).lineToLinearHeading(new Pose2d(parkLeft, Math.toRadians(180))).build();
