...
public class PropPipeline implements VisionProcessor, CameraStreamSource {
     ...
     */
    public PropPipeline(@NonNull Scalar lower, @NonNull Scalar upper, DoubleSupplier minArea, DoubleSupplier left, DoubleSupplier right) {
        ...
        textPaint.setColor(Color.WHITE); // you may want to change this
        ...
        linePaint = new Paint();
        linePaint.setColor(Color.WHITE); // you may want to change this
