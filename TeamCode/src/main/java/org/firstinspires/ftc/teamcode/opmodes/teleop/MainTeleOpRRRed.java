...
@TeleOp(name = "MainTeleOpRRRed")
public class MainTeleOpRRRed extends LinearOpMode {
    Arm arm;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        backBoardPose = new Pose2d(44.9, -34, Math.toRadians(0));
        pickUpPose = new Pose2d(-52,52, Math.toRadians(135));
